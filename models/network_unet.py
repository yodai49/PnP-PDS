...
class UNet(nn.Module):
    def __init__(self, file_name = "", in_nc=1, out_nc=1, nc=[64, 128, 256, 512], nb=2, act_mode='R', downsample_mode='strideconv', upsample_mode='convtranspose'):
        super(UNet, self).__init__()

        self.load_state_dict(torch.load(file_name), strict=True)
...
class UNetRes(nn.Module):
    def __init__(self, file_name = "", in_nc=1, out_nc=1, nc=[64, 128, 256, 512], nb=4, act_mode='R', downsample_mode='strideconv', upsample_mode='convtranspose'):
...
class ResUNet(nn.Module):
    def __init__(self, file_name = "", in_nc=1, out_nc=1, nc=[64, 128, 256, 512], nb=4, act_mode='L', downsample_mode='strideconv', upsample_mode='convtranspose'):
